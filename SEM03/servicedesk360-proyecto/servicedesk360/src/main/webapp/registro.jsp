    ...
    <form action="${pageContext.request.contextPath}/registro" method="post" autocomplete="off">
        ...
        <div class="grupo-campo">
            ...
            <select id="rol" name="rol" required>
                ...
                <option value="SOLICITANTE" ${rolAnterior == 'SOLICITANTE' ? 'selected' : ''}>Solicitante</option>
                <option value="TECNICO" ${rolAnterior == 'TECNICO' ? 'selected' : ''}>Técnico</option>
            </select>
        </div>
        <div class="grupo-campo">
